...
# This repo has no root-level variables left as of the SOPS-to-
# Secrets-Manager cutover (PARKED.md), but kept as a cheap general
# safety default rather than removed along with that scenario.
